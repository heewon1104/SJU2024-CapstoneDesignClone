...
@Setter
@NoArgsConstructor
public class ComprehensiveDietInfoDto {
    ...
    @Builder
    public ComprehensiveDietInfoDto(List<DietDto> diets, List<FoodNutritionDto> dietDiaries, UserDiseaseInfoDto diseaseInfo,
